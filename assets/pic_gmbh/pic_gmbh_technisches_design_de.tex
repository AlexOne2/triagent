...
Frontend & Next.js, React, TypeScript. Enthält Uploads, In-tray, Dashboard, Report Detail, Resolve Drawer, Settings und Admin-Sichten.\\
Backend & FastAPI in Python mit serviceorientierter Struktur für Parsing, Triage, Assist Drafts, Evidence Export, Audit, RBAC und reproduzierbares Daten-Seeding.\\
...
Deployment & Docker Compose für lokalen und self-hosted Prototyp-Betrieb.\\
...
E-Mail-Intake & Upload und Parsing von \texttt{.eml} und \texttt{.msg}, Batch-Import synthetischer Validierungsdaten, Outlook Add-in für gemeldete Mails.\\
...
Assist Draft & Lokaler heuristischer Assist-Draft für Disposition, Klassifikation, Begründung und vorgeschlagene Artefakte. Aktuell früher Prototypstand.\\
...
Governance & Session-RBAC, Rollen/Rechte, API Keys, Audit Events und Audit Export.\\
...
\begin{itemize}
  \item \textbf{Triage und Assist Draft sind noch frühe Heuristiken}. Sie funktionieren für synthetische Validierungsfälle, brauchen aber reale Daten, Tuning und saubere Bewertungsmetriken.
...
\begin{itemize}
  \item lauffähiger Prototyp-Stack mit Frontend, Backend, Datenbank und Objektspeicher
  ...
  \item reproduzierbare Validierungsdatensätze für Tests und Walkthroughs
\end{itemize}
...
Triagent hat bereits einen funktionsfähigen Kern für reported-email triage, Evidence Review, Assist Drafts, Resolution und Exporte. Die größten offenen Arbeiten liegen in Produktisierung, Engine-Erweiterbarkeit, Integrationen, Betriebshärtung und echter Validierung auf realistischen Workflows.
